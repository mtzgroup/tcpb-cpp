...
public:
   ...
   **/
  bool HasSameFD(const Socket &other) const {
...
public:
  ...
  void swap(SelectServerSocket &other)                      =
    delete; // Helper swap function
  SelectServerSocket(SelectServerSocket &&move)             =
    delete; // Move constructor
  SelectServerSocket &operator=(SelectServerSocket &&move)  =
